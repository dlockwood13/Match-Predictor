...
const PREMIER_LEAGUE = {
  'Manchester City': { elo: 1925, attack: 2.45, defense: 0.88, scorers: [['Haaland', 0.44], ['Semenyo', 0.18], ['Foden', 0.10], ['Cherki', 0.08]] },
  'Liverpool': { elo: 1870, attack: 2.1, defense: 0.95, scorers: [['Ekitike', 0.22], ['Gakpo', 0.16], ['Diaz', 0.14], ['Jota', 0.10]] },
  'Arsenal': { elo: 1910, attack: 2.3, defense: 0.88, scorers: [['Gyokeres', 0.30], ['Havertz', 0.14], ['Saka', 0.13], ['Odegaard', 0.10]] },
  'Chelsea': { elo: 1820, attack: 2.1, defense: 1.05, scorers: [['Joao Pedro', 0.28], ['Palmer', 0.16], ['Nkunku', 0.12], ['Madueke', 0.09]] },
  'Nottingham Forest': { elo: 1820, attack: 1.85, defense: 0.92, scorers: [['Gibbs-White', 0.24], ['Wood', 0.18], ['Elanga', 0.14], ['Hudson-Odoi', 0.10]] },
  'Newcastle': { elo: 1800, attack: 2.0, defense: 1.05, scorers: [['Isak', 0.32], ['Gordon', 0.15], ['Barnes', 0.11], ['Joelinton', 0.08]] },
  'Aston Villa': { elo: 1790, attack: 2.05, defense: 1.10, scorers: [['Watkins', 0.28], ['Rogers', 0.14], ['Bailey', 0.12], ['McGinn', 0.09]] },
  'Brentford': { elo: 1780, attack: 2.0, defense: 1.15, scorers: [['Igor Thiago', 0.40], ['Mbeumo', 0.12], ['Wissa', 0.14], ['Schade', 0.10]] },
  'Tottenham': { elo: 1760, attack: 1.95, defense: 1.25, scorers: [['Solanke', 0.22], ['Son', 0.18], ['Kulusevski', 0.12], ['Johnson', 0.10]] },
  'Manchester United': { elo: 1710, attack: 1.75, defense: 1.35, scorers: [['Mbeumo', 0.22], ['Cunha', 0.20], ['Hojlund', 0.16], ['Fernandes', 0.10]] },
  'Brighton': { elo: 1720, attack: 1.75, defense: 1.25, scorers: [['Welbeck', 0.22], ['Mitoma', 0.16], ['Minteh', 0.14], ['Rutter', 0.10]] },
  'Fulham': { elo: 1710, attack: 1.65, defense: 1.30, scorers: [['Wilson H', 0.22], ['Jimenez', 0.20], ['Iwobi', 0.12], ['Andreas', 0.09]] },
  'Crystal Palace': { elo: 1690, attack: 1.55, defense: 1.28, scorers: [['Mateta', 0.28], ['Eze', 0.20], ['Sarr', 0.12], ['Munoz', 0.08]] },
  'West Ham': { elo: 1680, attack: 1.60, defense: 1.35, scorers: [['Bowen', 0.24], ['Kudus', 0.18], ['Fullkrug', 0.14], ['Paqueta', 0.09]] },
  'Bournemouth': { elo: 1720, attack: 1.80, defense: 1.20, scorers: [['Kroupi', 0.22], ['Kluivert', 0.18], ['Tavernier', 0.14], ['Brooks', 0.10]] },
  'Everton': { elo: 1640, attack: 1.45, defense: 1.40, scorers: [['Ndiaye', 0.20], ['Grealish', 0.16], ['Garner', 0.12], ['McNeil', 0.10]] },
  'Wolves': { elo: 1630, attack: 1.45, defense: 1.45, scorers: [['Cunha', 0.26], ['Strand Larsen', 0.18], ['Hwang', 0.10], ['Sarabia', 0.08]] },
  'Leeds': { elo: 1700, attack: 1.65, defense: 1.30, scorers: [['Calvert-Lewin', 0.28], ['James', 0.14], ['Aaronson', 0.12], ['Gnonto', 0.10]] },
  'Ipswich': { elo: 1600, attack: 1.40, defense: 1.50, scorers: [['Delap', 0.24], ['Hutchinson', 0.14], ['Broadhead', 0.12], ['Clarke', 0.09]] },
  'Sunderland': { elo: 1580, attack: 1.35, defense: 1.55, scorers: [['Mayenda', 0.20], ['Isidor', 0.15], ['Le Fee', 0.12], ['Roberts', 0.09]] },
};
